...
const DIRECTIONS: {
  ...
  },
  {
    ...
    name: "Local Almanac",
    tag: "Heritage",
    desc: "A printed town-guide feel. Masthead, sticky index rail, drop caps, hairline rules, and an engraved compass rose. Leans hardest into the main street metaphor.",
    bg: "#faf3e8",
    fg: "#1e3a2f",
    accent: "#b5551f",
    serif: true,
